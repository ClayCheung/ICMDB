...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=cableTable.models.basefile_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cableTable.Asset')),
            ],
            options={
                'verbose_name': '网络设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cableTable.Asset')),
                ('remotePort', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cableTable.Port')),
            ],
            options={
                'verbose_name': '端口名',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cableTable.Project'),
        ),
        migrations.AddField(
            model_name='asset',
            name='locate',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cableTable.Locate', verbose_name='所在位置'),
        ),
        migrations.AddField(
            model_name='asset',
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cableTable.Project', verbose_name='所属项目'),
        ),
